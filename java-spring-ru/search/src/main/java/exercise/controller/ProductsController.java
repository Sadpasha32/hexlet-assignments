...
public class ProductsController {
    ...
    @GetMapping
    public List<ProductDTO> getAll(ProductParamsDTO productParamsDTO, @RequestParam(defaultValue = "1") int page) {
        var spec = productSpecification.build(productParamsDTO);
